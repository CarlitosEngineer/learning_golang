...
func Learning_DataTypes_Consts1() {
	// Constantes
...
func Learning_DataTypes_Integers1() {
	// Signed
...
func Learning_DataTypes_FloatingPoints1() {
	// Flotantes
...
func Learning_DataTypes_Complex1() {
	// Complejos
...
func Learning_DataTypes_shorthand1() {
	// Declaración rápida
	shorthand := "Variable declarada con :="
	fmt.Println("Shorthand:", shorthand)
}

func Ejecutar_cap1Go() {
	Learning_DataTypes_shorthand1()
	Learning_DataTypes_Consts1()
	Learning_DataTypes_Integers1()
	Learning_DataTypes_FloatingPoints1()
	Learning_DataTypes_Booleans1()
	Learning_DataTypes_Runes1()
	Learning_DataTypes_Complex1()
	Learning_DataTypes_uintptr1()
	Learning_DataTypes_DefaultValue1()
}
